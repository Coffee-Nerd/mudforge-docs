...
All API documentation in this site has been verified against the actual MudForge source code. Each function includes a reference to its source file for transparency.
